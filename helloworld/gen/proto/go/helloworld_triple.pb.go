...
func (c *GreeterClientImpl) XXX_InterfaceName() string {
	return "com.github.wesleywu.helloworld.Greeter"
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc_go.CallOption) (*HelloReply, common.ErrorWithAttachment) {
	out := new(HelloReply)
...
var Greeter_ServiceDesc = grpc_go.ServiceDesc{
	ServiceName: "com.github.wesleywu.helloworld.Greeter",
